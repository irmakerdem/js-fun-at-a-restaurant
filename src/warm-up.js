...
var shouldOrderMore;
if (inStock < 20) {
  console.log(shouldOrderMore = true);
} else {
  console.log(shouldOrderMore = false);
};
...
var vegetable = ["arugula", "broccoli", "pumpkin", "eggplant", "cucumber"];
...
// different fruits.
var fruits = ["banana", "apple", "blackberry", "orange", "lime", "strawberry", "mango"];
...
//Add a key value pair occupyLimit: 200;
